...
public abstract class BlockLogicWorkbenchMixin extends BlockLogic implements IPaintable {
	public BlockLogicWorkbenchMixin(Block<?> block, Material material) {
		super(block, material);
	}

	public void setColor(World world, int x, int y, int z, DyeColor color) {
		world.setBlock(x, y, z, DyablesBlocks.WORKBENCH_PAINTED.id());
		DyablesBlocks.WORKBENCH_PAINTED.getLogic().setColor(world, x, y, z, color);
	}
}
